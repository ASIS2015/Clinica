...
out.println("<form action='factura_seguimiento.jsp' method='POST'> <input type='hidden' name='id' value='"+rs.getInt("id")+"'> <input type='hidden' name='opc' value='1'></th> <th> <center><input type='Submit' value='Ver' class='btn btn-info'></center> </form> </th>  ");
out.println("</tr>");
}
...
%>                                           
                            ...
                            <div class="well">
                                ...
                                <p>Busque y acceda al modulo Facturaci&oacute;n.</p>
