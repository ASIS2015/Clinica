...
<input type="search" id="brand-filter" placeholder="Buscar..." name="paciente" data-list="brands-list" autocomplete="off" required />
    ...
    <datalist id="brands-list">
      <select>
         ...
         rs3 = Estamento3.executeQuery("select * from personal order by Nombres Asc");
                                                    
        while(rs3.next()){
                                                        
                                                        
            out.println("<option value=\""+rs3.getString("Nombres")+", "+rs3.getString("Apellidos")+"\" /></option>");
                                                        
                                                    
        }
                                                    
                                                          
       if(rs2.getInt("id_estado")==3){
       ...
       %>
                                        ...
                                        <tr>
                                            <th>Precio:</th>
                                            <th>$<% out.print(rs.getString("precio")); total_consulta=Double.parseDouble(rs.getString("precio")); %></th>
                                        </tr>                                        
                                        <tr>
...
<%
    ...
    while(rs3.next()){
        ...
        total_medicina=total_medicina+(Integer.parseInt(rs3.getString("Cantidad"))* Double.parseDouble(rs3.getString("precio")));
    ...
    out.print("<tr> <th colspan='2'>Total Medicina: </th> <th colspan='2'><center>$"+total_medicina+"</center></th> </tr>");
       ...
       total=total_medicina+total_consulta;                                           
%>                                
...
if(estado!=2 && rs2.getInt("id_estado")==4){
 ...
 <%
 if(rs2.getInt("id_estado")==2 || estado==2 ){
 %>
                            <div class="panel panel-primary">
                        <div class="panel-heading">
                            <div class="row">
                        ...
                        <a href="#">
                            <div class="panel-footer" id="impr">
