...

         {
            ...
            Connection  conexion = DBConexion.obtener();
             ...
             Statement Estamento = conexion.createStatement();
                ...
                try{
                Estamento.executeUpdate("INSERT INTO personal VALUES (0,'"+nombre+"','"+apellido+"','"+dui+"','"+celular+"','"+fijo+"','"+nac+"','"+email+"','"+dom+"',1)");
               ...
               estado=1;
               mensaje = "Datos No Guardados, DUI de paciente ya existe en la Base de Datos.";
...
<form action="" name="frmusuarios" method="POST"> 
                                        ...
                                        <tr>
                                            ...
                                            <th>DUI:</th>
                                            <th><input type="text" name="dui"> </th>
                                        </tr>
                                        <tr>
                                            <th>Celular:</th>
                                            ...
                                            <th>Fijo:</th>
                                            <th><input type="text" name="fijo"> </th>
                                        </tr>                                          <tr>
                                            <th>Nacimiento:</th>
                                            <th><input type="date" name="nac"> </th>
                                        </tr>                                          <tr>
                                            <th>E-mail:</th>
                                            <th><input type="email" name="email" id="email"> </th>
                                        </tr>                                          <tr>
                                            <th>Domicilio:</th>
                                            <th><input type="text" name="dom"> </th>
