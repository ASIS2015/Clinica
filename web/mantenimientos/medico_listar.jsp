...
<jsp:include page="../comunes/head.jsp"></jsp:include>
       ...
       <div class="panel panel-default">
                        <div class="panel-heading">
                            Administraci&oacute;n de M&eacute;dicos
                        </div>
                        <!-- /.panel-heading -->
                    ...
                    if(DBConexion.obtener() !=null)
{
    ...
    ResultSet rs = Estamento.executeQuery("select * from personal where id_tipo=2");
...
%>                                           
                            ...
                            <!-- /.table-responsive -->
                            <div class="well">
                                <h4>M&eacute;dicos:</h4>
                                <p>Busque y acceda al modulo de modificar el M&eacute;dicos, o si lo desea puede eliminarlo directamente. (nota) Necesitara privilegios de administrador</p>
