...
out.println("<form action='cita.jsp' method='POST'> <input type='hidden' name='id' value='"+rs.getInt("id")+"'> <input type='hidden' name='opc' value='1'></th> <th> <center><input type='Submit' value='Iniciar Cita' class='btn btn-info'></center> </form> </th>  ");
out.println("</tr>");
}
